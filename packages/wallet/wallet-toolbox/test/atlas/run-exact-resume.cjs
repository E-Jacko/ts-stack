...
const scenarios = ['normal', 'failure-during-post', 'lost-response', 'already-known', 'concurrent', 'malformed', 'wrong-id', 'foreign-owner', 'output-mismatch', 'reallocated', 'prequeue-crash', 'postqueue-crash', 'status-commit-crash', 'provider-unknown', 'malformed-status', 'restart', 'delayed', 'delayed-race', 'proof']
